...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        # self.inputDate.setDateTime(QtCore.QDateTime(QtCore.QDate(2000, 1, 1), QtCore.QTime(0, 0, 3)))
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.buttonLogin.setText(_translate("mainWindow", "Login in"))
        self.label.setText(_translate("mainWindow", "Status:"))
        self.labelStatus.setText(_translate("mainWindow", "Error contection"))
        self.buttonGetImages.setText(_translate("mainWindow", "Get Images"))
        self.label_3.setText(_translate("mainWindow", "QA:"))
        self.label_2.setText(_translate("mainWindow", "PT:"))
        self.buttonChange.setText(_translate("mainWindow", "Change"))
